...
public class VaccineController {
	...
	public ResponseEntity<Vaccine> getVaccineById(@RequestParam Integer id){
	...
	public ResponseEntity<Vaccine> updateVaccineDetails(@RequestParam Integer id,@RequestBody Vaccine v){
		Vaccine vaccine=vaccineService.updateVaccine(id, v);
		return new ResponseEntity<>(vaccine,HttpStatus.ACCEPTED);
	}
	
	@DeleteMapping("/deleteVaccine/{id}")
	public ResponseEntity<String> deleteVaccine(@RequestParam Integer id){
